    ...
    return (
        <div className="flex flex-row justify-between items-center px-10 py-5 w-full">
            ...
            <div className="flex flex-row gap-5">
                <Link href="/about" style={{ color: textcolor }}>¿Qué hago?</Link>
                <hr className="border border-gray-600 h-6" />
                <Link href="/projects" style={{ color: textcolor }}>Experiencia</Link>
                <hr className="border border-gray-600 h-6" />
                <Link href="/contact" style={{ color: textcolor }}>Contacto</Link>
            </div>
        </div>
    );
};
