    ...
    return(
        <div className="w-full px-4">
            ...
            <p className='text-white text-lg mr-32'>
                Construyo experiencias digitales intuitivas y eficientes que combinan creatividad y funcionalidad. Como desarrollador web, me especializo 
                principalmente en frontend para crear sitios modernos y aplicaciones robustas utilizando tecnologías de vanguardia. 
                Cada línea de código está orientada a resolver problemas, mejorar la experiencia del usuario y lograr resultados óptimos.
            </p>
